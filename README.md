...
In order to build Evolution from its source code you need to download Unity 6000.2.2f1 (including its iOS build support modules). Then, you can just open the folder in Unity, select a platform (command + shift + B) and build the application for that platform.
